...
<div class="tab-content cop-tab-content">
    ...
    <div id="cop_costs" class="tab-pane fade">
        <div class="cop-section-heading"><div><span class="cop-eyebrow">Costos vinculados</span><h6>Detalle de gastos oficiales y no oficiales</h6><small>El total registrado se conserva. En modo Con IGV, los gastos oficiales afectos se descuentan por su base sin IGV.</small></div><div class="cop-section-total"><small>Total registrado</small><strong>{{$money($linkedTotal)}}</strong></div></div>
