                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="supplierOrderAdvancePaymentsSection" class="supplier-order-advance-field">
                                            ...
                                            <div class="supplier-order-new-advance-payment">
                                                ...
                                                <div id="supplierOrderNewPaymentUnavailable" class="alert alert-info py-2 d-none"><i class="fas fa-info-circle mr-1"></i><span>No hay saldo pendiente para registrar nuevos pagos.</span></div>
                                                <div id="supplierOrderNewPaymentFields" class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2"><label>NRO. OPERACIÓN</label><input type="text" name="advance_payments[0][operation_number]" id="supplier_order_new_advance_operation_number" class="form-control form-control-sm text-uppercase" maxlength="100"></div>
