        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
            ...
            <div>
                ...
                <small class="text-muted">
                    Gestión y administración de marcas del sistema.
                </small>
...
@section('content_body')
    ...
    <div class="card border-0 shadow-lg rounded-xl">
        ...
        <div class="card-body pt-2">
            ...
            <div class="table-responsive">
                ...
                <table id="tableBrand" class="table table-hover align-middle text-center w-100">
    ...
    @include('admin.brands.partials.viewModal')
...
@push('js')
    <script>
        window.routes = {
            ...
            brandList: "{{ route('admin.brands.list') }}",

            storeBrand: "{{ route('admin.brands.store') }}",

            updateBrand: "{{ url('admin/brands') }}",

            deleteBrand: "{{ url('admin/brands') }}",

            generateBrandCode: "{{ route('admin.brands.generateCode') }}",
