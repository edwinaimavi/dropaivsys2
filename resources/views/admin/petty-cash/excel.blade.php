...
<tr><td><b>Periodo</b></td><td>{{ str_pad($box->period_month,2,'0',STR_PAD_LEFT) }}/{{ $box->period_year }}</td><td><b>Saldo anterior</b></td><td>{{ $box->previous_balance }}</td><td><b>Fondo aprobado</b></td><td>{{ $box->approved_fund }}</td><td><b>Fondo inicial</b></td><td>{{ $box->opening_amount }}</td></tr>
