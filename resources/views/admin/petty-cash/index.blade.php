...
<style>
    ...
    .petty-actions-menu{z-index:1080;min-width:210px}
    ...
    .petty-main-actions{display:inline-flex;align-items:center;gap:5px}.petty-main-actions>.btn,.petty-actions-trigger{height:31px;border-radius:8px;font-size:.68rem;font-weight:800}.petty-actions-trigger:after{display:none}.petty-actions-menu{min-width:220px;padding:7px;border:1px solid #e0e7e4;border-radius:12px;box-shadow:0 14px 35px rgba(15,23,42,.16)}.petty-actions-menu .dropdown-header{padding:5px 9px;color:#96a09c;font-size:.52rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase}.petty-actions-menu .dropdown-item{display:flex;padding:7px 9px;align-items:center;border:0;border-radius:7px;background:transparent;color:#42534d;font-size:.67rem}.petty-actions-menu .dropdown-item i{width:20px;margin-right:5px;text-align:center}.petty-actions-menu .dropdown-item:hover{background:#f0f7f4;color:#205f49}.petty-actions-menu .dropdown-item:disabled{color:#adb5b2;background:transparent}.petty-actions-menu .dropdown-divider{margin:5px 0;border-color:#edf1ef}
