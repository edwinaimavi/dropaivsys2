                ...
                <div class="modal-header petty-expense-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p>El saldo disponible se recalculará automáticamente.</p>
                        </div>
                    </div>
                ...
                <div class="modal-body petty-expense-body">
                    ...
                    <section class="petty-expense-card">
                        <div class="petty-expense-section-title">
                            ...
                            <div><h6>Detalle del gasto</h6><small>Concepto e importe que afectarán el saldo de caja</small></div>
                        </div>
                        <div class="form-row">
                    ...
                    <section class="petty-expense-card mb-0">
                        <div class="petty-expense-section-title">
                            ...
                            <div><h6>Comprobante adjunto</h6><small>PDF o imagen, máximo 10 MB</small></div>
                        </div>
                        <label class="petty-file-control">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <span><strong>Seleccionar sustento</strong><small>PDF, JPG, JPEG o PNG</small></span>
