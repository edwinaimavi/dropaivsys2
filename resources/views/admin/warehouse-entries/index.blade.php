...
@push('css')
    <style>
        ...
        @media (max-width: 575.98px) {
            ...
            .warehouse-entry-expenses-table-wrap{border:0;overflow:visible;background:transparent}.warehouse-entry-expenses-table,.warehouse-entry-expenses-table tbody,.warehouse-entry-expenses-table tr,.warehouse-entry-expenses-table td{display:block;width:100%}.warehouse-entry-expenses-table thead{display:none}.warehouse-entry-expenses-table tbody tr{margin-bottom:9px;padding:8px 10px;border:1px solid #e1ebe9;border-radius:10px;background:#fff;box-shadow:0 3px 10px rgba(37,62,54,.04)}.warehouse-entry-expenses-table tbody td{display:flex;padding:5px 0;justify-content:space-between;border:0;text-align:right!important}.warehouse-entry-expenses-table tbody td:before{margin-right:10px;color:#7b8985;font-size:8px;font-weight:900;text-transform:uppercase}.warehouse-entry-expenses-table tbody td:nth-child(1):before{content:'Categoría'}.warehouse-entry-expenses-table tbody td:nth-child(2):before{content:'Tipo'}.warehouse-entry-expenses-table tbody td:nth-child(3):before{content:'Origen'}.warehouse-entry-expenses-table tbody td:nth-child(4):before{content:'Proveedor'}.warehouse-entry-expenses-table tbody td:nth-child(5):before{content:'Comprobante'}.warehouse-entry-expenses-table tbody td:nth-child(6):before{content:'Importe'}.warehouse-entry-expenses-table tbody td:nth-child(7):before{content:'Inventario'}.warehouse-entry-expenses-table tbody td:nth-child(8):before{content:'Distribución'}.warehouse-entry-expenses-table tbody td:nth-child(9):before{content:'Adjunto'}.warehouse-entry-expenses-table tbody td:nth-child(10):before{content:'Acciones'}
        }
