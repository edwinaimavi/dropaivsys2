            ...
            <div class="modal-body warehouse-entry-modal-body">
                ...
                <div class="tab-content warehouse-entry-view-tab-content">
                    ...
                    <div class="tab-pane fade" id="vwe_expenses_tab"><div class="card border-0 shadow-sm warehouse-entry-card">
                        ...
                        <div class="card-body p-0"><div class="table-responsive"><table class="table table-sm table-hover mb-0"><thead><tr><th>Categoría</th><th>Tipo</th><th>Origen</th><th>Proveedor</th><th>Comprobante</th><th class="text-right">Importe</th><th>IGV</th><th>Inventario</th><th>Distribución</th><th>Documentos</th></tr></thead><tbody id="vwe_expenses"></tbody></table></div></div>
                        <div class="card-footer"><div class="row"><div class="col-md-5 ml-auto"><div class="warehouse-entry-total-row"><span>Flete / transporte</span><strong id="vwe_expenses_freight">0.00</strong></div><div class="warehouse-entry-total-row"><span>Otros gastos</span><strong id="vwe_expenses_other">0.00</strong></div><div class="warehouse-entry-total-row"><span>Gastos informativos</span><strong id="vwe_expenses_informative">0.00</strong></div><div class="warehouse-entry-total-row"><span>Afectan inventario</span><strong id="vwe_expenses_inventory">0.00</strong></div><div class="warehouse-entry-total-row warehouse-entry-total-row-grand"><span>Costo real de ingreso</span><strong id="vwe_real_total">0.00</strong></div></div></div></div>
                    </div></div>
                    @endcan
