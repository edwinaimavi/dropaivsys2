                                ...
                                <section class="warehouse-entry-expense-list-panel" aria-labelledby="warehouseEntryExpenseListTitle">
                                    <div class="warehouse-entry-expense-list-summary">
                                        ...
                                        <div class="warehouse-entry-expense-kpis">
                                            ...
                                            <div class="warehouse-entry-expense-kpi"><i class="fas fa-list-alt"></i><span>Total registrado<strong id="warehouseEntryExpenseRegisteredTotal">0.00</strong></span></div>
                                            <div class="warehouse-entry-expense-kpi"><i class="fas fa-clock"></i><span>Pendiente de aprobaci&oacute;n<strong id="warehouseEntryExpensePendingTotal">0.00</strong></span></div>
                                            <div class="warehouse-entry-expense-kpi"><i class="fas fa-check-circle"></i><span>Total aprobado<strong id="warehouseEntryExpenseApprovedTotal">0.00</strong></span></div>
                                            <div class="warehouse-entry-expense-kpi is-total"><i class="fas fa-coins"></i><span>Total vinculado general<strong id="warehouseEntryExpenseLinkedTotal">0.00</strong></span></div>
                                        </div>
                                    </div>
