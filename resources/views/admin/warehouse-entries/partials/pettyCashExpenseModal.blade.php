    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header warehouse-entry-section-header align-items-center">
                <div class="d-flex align-items-center"><span class="warehouse-entry-petty-cash-icon"><i class="fas fa-cash-register"></i></span><div><h5 class="modal-title mb-0">Jalar gastos desde Caja Chica</h5><small class="text-muted">Solo gastos activos, aprobados y aún no vinculados a otro ingreso.</small></div></div>
            ...
            <div class="modal-body">
                <div class="card border-0 warehouse-entry-petty-cash-filters mb-3"><div class="card-body py-3"><div class="form-row align-items-end">
                    ...
                    <div class="form-group col-lg-2 col-md-3"><label>ESTADO</label><select id="wePettyCashExchangeStatus" class="form-control form-control-sm"><option value="PENDIENTE_CANJE">Pendiente de canje</option><option value="CANJEADO">Canjeado</option><option value="all">Todos</option></select></div>
