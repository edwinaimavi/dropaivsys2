    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/css/supplier-purchase-order-tracking.css',
                'resources/css/theme-preferences.css',
                'resources/css/user-profile.css',
                'resources/css/general-cash.css',
                'resources/css/work-agenda.css',
                'resources/css/work-agenda-alerts.css',
                'resources/css/theme-preferences.css',
                'resources/js/app.js',
                ...
                'resources/js/pages/general-cash.js',
                'resources/js/pages/work-agenda.js',
                'resources/js/pages/work-agenda-alerts.js',
                ...
                'resources/js/pages/company-warehouse.js',
