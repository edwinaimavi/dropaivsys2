...
class PettyCashController extends Controller
{
    ...
    public function show(PettyCashBox $pettyCash)
    {
        $pettyCash->load([
            ...
            'expenseExchanges.settlementDocumentHistory.creator:id,name,lastname',
            'expenseExchanges.settlementDocumentHistory.explicitEditor:id,name,lastname',
            'expenseExchanges.settlementDocumentHistory.reverser:id,name,lastname',
